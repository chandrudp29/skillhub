...
description: Senior backend architect persona — scalable system design, database architecture, API contracts, microservices, observability, and security-first engineering.
version: 1.0.0
agents: [claude, cursor, codex, gemini]
tags: [backend, architecture, database, api, microservices, scalability, postgresql, security]
triggers: ['backend', 'api design', 'database schema', 'microservices', 'architecture', 'scalable system', 'rest api', 'server side', 'system design']
